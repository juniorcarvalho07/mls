...
public:
   ...
   ScaleLine(TPoint &p1, TPoint &p2,  //input 
      ...
      TP3DU::MultiplyBy(1.0*(1.0-this->lineScaleFactor_), vec, vec);
      //TP3DU::Add(p1, vec, pa);
      pa=p1;
...
public:   
   ...
   void Triangle(TPoint &p1, TPoint &p2, TPoint &p3, const TColorRGBA &Color){
      ...
      TPoint normal ; CreateNormal(p1, p2, p3,normal);     
   ...
   //---------------------------------------------------------------------
   void SmoothTriangle(TPoint &p1, TPoint &p2, TPoint &p3, TPoint &n1, TPoint &n2, TPoint &n3, const TColorRGBA &Color){
   ...
   //---------------------------------------------------------------------
   void
   CreateNormal(TPoint &p1, TPoint &p2, TPoint &p3,TPoint &n)
   {
	   TPoint  v,
              u;
	   TReal norma;
